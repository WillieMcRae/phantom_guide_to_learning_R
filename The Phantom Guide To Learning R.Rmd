...
- learn how to do some sort of programming, as a gateway drug into making interactive data visualizations and computer games in the future, and as an insurance policy to become more relevant for the age when the robots take over
...
[Kaggle](https://www.kaggle.com/) is a good place o get inspired and look at useful scripts and approaches to real world data problems.
...
[DataCamp](https://www.datacamp.com/) is completely worth the subscrioption fee and they also do Python courses.  
...
Use `mutate_each` from dplyr package to coerce multiple columns into differnt types  

...
- learn how to do some sort of programming 
...
- improve the output of my day to day activities around data analyis and data-driven decision making  
...
I have cerated a simple [template for exploratory analysis](https://github.com/WillieMcRae/r_templates/blob/master/Rmd_exploratory_template.Rmd)
